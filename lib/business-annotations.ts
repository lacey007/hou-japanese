...
import deepseek4150 from "@/data/business-deepseek-41-50.json";
import deepseek5170 from "@/data/business-deepseek-51-70.json";
...
const deepseek4150ByLine = Object.fromEntries(
  (deepseek4150 as DeepSeekSentenceNote[]).map(item => [item.line, item]),
) as Record<string, DeepSeekSentenceNote>;
const deepseek5170ByLine = Object.fromEntries(
  (deepseek5170 as DeepSeekSentenceNote[]).map(item => [item.line, item]),
) as Record<string, DeepSeekSentenceNote>;
const deepseek111120ByLine = Object.fromEntries(
  (deepseek111120 as DeepSeekSentenceNote[]).map(item => [item.line, item]),
) as Record<string, DeepSeekSentenceNote>;
const deepseek121130ByLine = Object.fromEntries(
  (deepseek121130 as DeepSeekSentenceNote[]).map(item => [item.line, item]),
) as Record<string, DeepSeekSentenceNote>;
const deepseek131140ByLine = Object.fromEntries(
  (deepseek131140 as DeepSeekSentenceNote[]).map(item => [item.line, item]),
) as Record<string, DeepSeekSentenceNote>;
const deepseek141150ByLine = Object.fromEntries(
  (deepseek141150 as DeepSeekSentenceNote[]).map(item => [item.line, item]),
) as Record<string, DeepSeekSentenceNote>;
const deepseek151160ByLine = Object.fromEntries(
  (deepseek151160 as DeepSeekSentenceNote[]).map(item => [item.line, item]),
) as Record<string, DeepSeekSentenceNote>;
const deepseek161170ByLine = Object.fromEntries(
  (deepseek161170 as DeepSeekSentenceNote[]).map(item => [item.line, item]),
) as Record<string, DeepSeekSentenceNote>;
...
export const grammarMemoForBusinessLine = (line: string) => {
  ...
  const page5170Note = deepseek5170ByLine[line];
  if (page5170Note?.grammar) {
    return [{ title: "DeepSeek 本句语法详解", detail: page5170Note.grammar }];
  }
  const page4150Note = deepseek4150ByLine[line];
  if (page4150Note?.grammar) {
    return [{ title: "DeepSeek 本句语法详解", detail: page4150Note.grammar }];
  }
  ...
  const page171180Note = deepseek171180ByLine[line];
  if (page171180Note?.grammar) {
    return [{ title: "DeepSeek 本句语法详解", detail: page171180Note.grammar }];
  }
  ...
  const page121130Note = deepseek121130ByLine[line];
  if (page121130Note?.grammar) {
    return [{ title: "DeepSeek 本句语法详解", detail: page121130Note.grammar }];
  }
  const page131140Note = deepseek131140ByLine[line];
  if (page131140Note?.grammar) {
    return [{ title: "DeepSeek 本句语法详解", detail: page131140Note.grammar }];
  }
  const page141150Note = deepseek141150ByLine[line];
  if (page141150Note?.grammar) {
    return [{ title: "DeepSeek 本句语法详解", detail: page141150Note.grammar }];
  }
  const page151160Note = deepseek151160ByLine[line];
  if (page151160Note?.grammar) {
    return [{ title: "DeepSeek 本句语法详解", detail: page151160Note.grammar }];
  }
  const page161170Note = deepseek161170ByLine[line];
  if (page161170Note?.grammar) {
