...
import corrections151160 from "@/data/business-pages-corrections-151-160.json";
import corrections161170 from "@/data/business-pages-corrections-161-170.json";
import corrections171180 from "@/data/business-pages-corrections-171-180.json";
import corrections181190 from "@/data/business-pages-corrections-181-190.json";
import corrections191203 from "@/data/business-pages-corrections-191-203.json";
...
export default function BusinessJapanesePage() {
  ...
  const allCorrections = [...corrections530, ...corrections3140, ...corrections, ...corrections97110, ...corrections111120, ...corrections121130, ...corrections131140, ...corrections141150, ...corrections151160, ...corrections161170, ...corrections171180, ...corrections181190, ...corrections191203, ...corrections818];
