...
export default function BusinessJapanesePage() {
  ...
  const allCorrections = [...corrections, ...corrections97110, ...corrections111120, ...corrections121130, ...corrections131140, ...corrections141150, ...corrections151160, ...corrections161170, ...corrections171180, ...corrections181190, ...corrections818];
